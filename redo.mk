...
PYTEST_CMD  := $(DOCKER_COMPOSE) run --rm --user $(UID):$(GID) --entrypoint pytest shell --html=log/pytest-report.html --self-contained-html
...
.PHONY: tags
tags:
	$(Q)ctags -R app/shell/py app/flashoffer/flashoffer-react/src
