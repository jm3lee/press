...
- [metadata-maintenance.md](metadata-maintenance.md) – CLI utilities for
  keeping metadata fields up to date.
...
- [standalone-bin-scripts.md](standalone-bin-scripts.md) – rationale for
