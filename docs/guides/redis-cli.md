...
`bin/redis-cli` wraps `docker compose exec dragonfly redis-cli` to connect to
the project's DragonflyDB/Redis instance. Any arguments passed to the script are
